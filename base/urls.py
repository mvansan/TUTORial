...
urlpatterns = [
    ...
    path('accept_matching/<int:matching_id>/', views.accept_matching_status, name='accept-matching'),
    path('decline_matching/<int:matching_id>/', views.decline_matching_status, name='decline-matching'),
